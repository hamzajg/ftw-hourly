...
import { EditConsultingAvailabilityPlanForm, EditConsultingAvailabilityExceptionForm } from '../../forms';

import css from './EditConsultingAvailabilityPanel.css';
...
//////////////////////////////////
const EditConsultingAvailabilityPanel = props => {
  const {
    className,
    rootClassName,
    listing,
  ...
  return (
    <main className={classes}>
      <h1 className={css.title}>
        {isPublished ? (
          <FormattedMessage
            id="EditConsultingAvailabilityPanel.title"
            values={{
              listingTitle: (
                <ListingLink listing={listing}>
                  <FormattedMessage id="EditConsultingAvailabilityPanel.listingTitle" />
                </ListingLink>
              ),
            }}
          />
        ) : (
          <FormattedMessage id="EditConsultingAvailabilityPanel.createListingTitle" />
        )}
      </h1>
      ...
      <section className={css.section}>
        <header className={css.sectionHeader}>
          <h2 className={css.sectionTitle}>
            <FormattedMessage id="EditConsultingAvailabilityPanel.defaultScheduleTitle" />
          </h2>
          <InlineTextButton
          ...
          >
            ...
            <FormattedMessage id="EditConsultingAvailabilityPanel.edit" />
          </InlineTextButton>
        </header>
      ...
      <section className={css.section}>
        <header className={css.sectionHeader}>
          <h2 className={css.sectionTitle}>
            {fetchExceptionsInProgress ? (
              <FormattedMessage id="EditConsultingAvailabilityPanel.availabilityExceptionsTitleNoCount" />
            ) : (
              <FormattedMessage
                id="EditConsultingAvailabilityPanel.availabilityExceptionsTitle"
        ...
        {fetchExceptionsInProgress ? (
          ...
          <div className={css.noExceptions}>
            <FormattedMessage id="EditConsultingAvailabilityPanel.noExceptions" />
          </div>
        ) : (
                  ...
                  <div className={css.exceptionHeader}>
                    <div className={css.exceptionAvailability}>
                      ...
                      <div className={css.exceptionAvailabilityStatus}>
                        {seats > 0 ? (
                          <FormattedMessage id="EditConsultingAvailabilityPanel.exceptionAvailable" />
                        ) : (
                          <FormattedMessage id="EditConsultingAvailabilityPanel.exceptionNotAvailable" />
                        )}
                      </div>
                    </div>
                    <button
        ...
        {exceptionCount <= MAX_EXCEPTIONS_COUNT ? (
          <InlineTextButton
            ...
            ready={ready}
          >
            <FormattedMessage id="EditConsultingAvailabilityPanel.addException" />
          </InlineTextButton>
        ) : null}
      </section>
      ...
      {errors.showListingsError ? (
        <p className={css.error}>
          <FormattedMessage id="EditConsultingAvailabilityPanel.showListingFailed" />
        </p>
      ) : null}
      ...
      {onManageDisableScrolling ? (
        <Modal
          ...
          usePortal
        >
          <EditConsultingAvailabilityPlanForm
            formId="EditConsultingAvailabilityPlanForm"
      ...
      {onManageDisableScrolling ? (
        <Modal
          ...
          usePortal
        >
          <EditConsultingAvailabilityExceptionForm
            formId="EditConsultingAvailabilityExceptionForm"
...
EditConsultingAvailabilityPanel.defaultProps = {
  className: null,
  rootClassName: null,
  listing: null,
  availabilityExceptions: [],
...
EditConsultingAvailabilityPanel.propTypes = {
  className: string,
...
export default EditConsultingAvailabilityPanel;
