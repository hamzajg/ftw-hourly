...
const LazyImage = lazyLoadWithDimensions(ServiceImage);

const serviceLink = (name, image, searchQuery) => {
  ...
  return (
    <NamedLink name="SearchPage" to={{ search: searchQuery }} className={css.location}>
      ...
      <div className={css.linkText} hidden>
        <FormattedMessage
          id="SectionServices.listingsInLocation"
          values={{ service: nameText }}
        />
      </div>
    </NamedLink>
  );
