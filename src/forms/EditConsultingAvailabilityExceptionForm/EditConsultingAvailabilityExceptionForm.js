...
import css from './EditConsultingAvailabilityExceptionForm.css';
...
//////////////////////////////////////////
const EditConsultingAvailabilityExceptionForm = props => {
  ...
  return (
    <FinalForm
      ...
      render={formRenderProps => {
        ...
        const idPrefix = `${formId}` || 'EditConsultingAvailabilityExceptionForm';
        const {
          availability,
          exceptionStartDate,
        ...
        return (
          ...
          >
            <h2 className={css.heading}>
              <FormattedMessage id="EditConsultingAvailabilityExceptionForm.title" />
            </h2>
            ...
            <div className={css.radioButtons}>
              <FieldRadioButton
                ...
                name="availability"
                label={intl.formatMessage({ id: 'EditConsultingAvailabilityExceptionForm.available' })}
                value="available"
              ...
              <FieldRadioButton
                ...
                label={intl.formatMessage({
                  id: 'EditConsultingAvailabilityExceptionForm.notAvailable',
                })}
                value="not-available"
              ...
              <div className={css.formRow}>
                <div className={css.field}>
                  <FieldDateInput
                    ...
                    label={intl.formatMessage({
                      id: 'EditConsultingAvailabilityExceptionForm.exceptionStartDateLabel',
                    })}
              ...
              <div className={css.formRow}>
                <div className={css.field}>
                  <FieldDateInput
                    ...
                    className={css.fieldDateInput}
                    label={intl.formatMessage({
                      id: 'EditConsultingAvailabilityExceptionForm.exceptionEndDateLabel',
                    })}
                    placeholderText={intl.formatDate(TODAY, dateFormattingOptions)}
                    format={formatFieldDateInput(timeZone)}
                    parse={parseFieldDateInput(timeZone)}
            ...
            <div className={css.submitButton}>
              {updateListingError ? (
                <p className={css.error}>
                  <FormattedMessage id="EditConsultingAvailabilityExceptionForm.updateFailed" />
                </p>
              ) : null}
              <PrimaryButton type="submit" inProgress={submitInProgress} disabled={submitDisabled}>
                <FormattedMessage id="EditConsultingAvailabilityExceptionForm.addException" />
              </PrimaryButton>
            </div>
          </Form>
        );
...
EditConsultingAvailabilityExceptionForm.defaultProps = {
  className: null,
  rootClassName: null,
  fetchErrors: null,
  formId: null,
...
EditConsultingAvailabilityExceptionForm.propTypes = {
  className: string,
...
export default compose(injectIntl)(EditConsultingAvailabilityExceptionForm);
