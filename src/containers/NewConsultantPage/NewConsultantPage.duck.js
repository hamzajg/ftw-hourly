...
export const SET_INITIAL_VALUES = 'app/NewConsultantPage/SET_INITIAL_VALUES';

export const SHOW_LISTING_REQUEST = 'app/NewConsultantPage/SHOW_LISTING_REQUEST';
export const SHOW_LISTING_ERROR = 'app/NewConsultantPage/SHOW_LISTING_ERROR';

export const FETCH_REVIEWS_REQUEST = 'app/NewConsultantPage/FETCH_REVIEWS_REQUEST';
export const FETCH_REVIEWS_SUCCESS = 'app/NewConsultantPage/FETCH_REVIEWS_SUCCESS';
export const FETCH_REVIEWS_ERROR = 'app/NewConsultantPage/FETCH_REVIEWS_ERROR';

export const FETCH_TIME_SLOTS_REQUEST = 'app/NewConsultantPage/FETCH_TIME_SLOTS_REQUEST';
export const FETCH_TIME_SLOTS_SUCCESS = 'app/NewConsultantPage/FETCH_TIME_SLOTS_SUCCESS';
export const FETCH_TIME_SLOTS_ERROR = 'app/NewConsultantPage/FETCH_TIME_SLOTS_ERROR';

export const FETCH_LINE_ITEMS_REQUEST = 'app/NewConsultantPage/FETCH_LINE_ITEMS_REQUEST';
export const FETCH_LINE_ITEMS_SUCCESS = 'app/NewConsultantPage/FETCH_LINE_ITEMS_SUCCESS';
export const FETCH_LINE_ITEMS_ERROR = 'app/NewConsultantPage/FETCH_LINE_ITEMS_ERROR';

export const SEND_ENQUIRY_REQUEST = 'app/NewConsultantPage/SEND_ENQUIRY_REQUEST';
export const SEND_ENQUIRY_SUCCESS = 'app/NewConsultantPage/SEND_ENQUIRY_SUCCESS';
export const SEND_ENQUIRY_ERROR = 'app/NewConsultantPage/SEND_ENQUIRY_ERROR';
...
const NewConsultantPageReducer = (state = initialState, action = {}) => {
...
export default NewConsultantPageReducer;
