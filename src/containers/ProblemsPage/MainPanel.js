...
import { validFilterParams } from './ProblemsPage.helpers';
...
class MainPanel extends Component {
  ...
  handleSortBy(urlParam, values) {
    ...
    history.push(createResourceLocatorString('ProblemsPage', routeConfiguration(), {}, queryParams));
  }
          ...
          >
            {searchListingsError ? (
              <h2 className={css.error}>
                <FormattedMessage id="ProblemsPage.searchError" />
              </h2>
            ) : null}
            <SearchResultsPanel
