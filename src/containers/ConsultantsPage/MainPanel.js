...
import { validFilterParams } from './ConsultantsPage.helpers';
...
class MainPanel extends Component {
    ...
    return updatedURLParams => {
      ...
      const callback = () => {
        if (useHistoryPush) {
          ...
          const search = cleanSearchFromConflictingParams(searchParams, sortConfig, filterConfig);
          history.push(createResourceLocatorString('ConsultantsPage', routeConfiguration(), {}, search));
        }
      };
  ...
  handleSortBy(urlParam, values) {
    ...
    history.push(createResourceLocatorString('ConsultantsPage', routeConfiguration(), {}, queryParams));
  }
