...
export class ConsultingPageComponent extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    const shouldShowPublicConsultingPage = pendingIsApproved || pendingOtherUsersListing;

    if (shouldShowPublicConsultingPage) {
...
ConsultingPageComponent.defaultProps = {
...
ConsultingPageComponent.propTypes = {
  // from withRouter
  history: shape({
...
ConsultingPage.setInitialValues = initialValues => setInitialValues(initialValues);
ConsultingPage.loadData = loadData;
